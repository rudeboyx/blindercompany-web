...
export default function Home() {
  ...
  const loadStock = async () => {
    try {
      const response = await fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vS_p0-S96_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9_9f9v9/pub?output=csv');
  ...
  return (
    <div style={{ backgroundColor: '#00050a', color: 'white', minHeight: '100vh', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ position: 'fixed', top: 0, left: 0, background: 'red', color: 'white', padding: '5px', zIndex: 10000, fontSize: '10px' }}>
        V2-NEXTJS-DEPLOY
      </div>
      ...
      {/* Header / Nav */}
      <nav style={{ padding: '24px 0', position: 'fixed', width: '100%', top: 0, zIndex: 1000, background: 'rgba(0, 5, 10, 0.8)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
